...
export default function FruitList() {
  ...
  const filteredFruits = fruits.filter(
    (fruit) =>
      fruit.name.toUpperCase().includes(filterText.toUpperCase()) ||
      fruit.color.toUpperCase().includes(filterText.toUpperCase())
  );
  ...
  return (
    <div >
      ...
      <div>
        ...
        <input type="text" id="fruitName" value={newFruitName} onChange={(e) => setNewFruitName(e.target.value)}
        />
        <label htmlFor="fruitColor">Color:</label>
        <input type="text"id="fruitColor"value={newFruitColor}onChange={(e) => setNewFruitColor(e.target.value)}/>
